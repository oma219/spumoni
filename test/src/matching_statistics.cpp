 ...
 */
  ...
  * Description: Main file for running SPUMONI to compute MSs
  *              against a reference.
  *
...
//
 // Class for storing the MS index, and has functions that
 // can be called to compute MS given a pattern.
 //
